...
- **蓝色雨滴桌宠**：透明置顶的史莱姆桌宠，可拖动、互动、显示漫画气泡，并与主界面共享对话记录。
...
- 支持鼠标跟随、挤压、水波、回弹、边缘吸附、待机、犯困和前后空翻。
...
日志生成在 `<安装目录>\logs\`，记录后端启动、API 请求、模型连接、文档分析、语言包下载和异常信息。接口说明见[调试接口](docs/DEBUG_API.md)。
