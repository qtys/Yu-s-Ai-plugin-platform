...
当前发布版：**0.15.17** · Windows x64 · 角色聊天 + 桌面陪伴

> ### ⬇ 下载 Windows 安装版
>
> [**下载最新版 Yus AI 安装程序（Windows x64）**](https://github.com/qtys/Yu-s-Ai-plugin-platform/releases/latest/download/Yus-AI-0.15.17-x64-setup.exe)
...
```text
frontend\src-tauri\target\release\bundle\nsis\Yus AI_0.15.17_x64-setup.exe
```
